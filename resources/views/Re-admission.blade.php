                    ...
                    <div class="card-body pt-4 p-3">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input {{ $isDisabled ? 'disabled' : '' }} required class="form-control @error('year_admitted') border-danger @enderror" type="text" placeholder="Year Admitted" id="year_admitted" name="year_admitted" value="{{ old('year_admitted') ?? $formData->year_admitted }}" >
                                @error('year_admitted')
            ...
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header pb-0">
                            <h6 class="font-weight-bolder alert alert-warning mx-10 role=alert text-white text-center text-primary">Student Requirements for Re-Admission/Returnee</h6>
                    </div>
                                                    ...
                                                    <div class="d-flex align-items-center justify-content-start gap-2">
                                                        ...
                                                        <div>
                                                            <a data-fslightbox="all-requirements" href="/images/freshmen/{{$r_document->image}}">
                                                                <img src="/images/returnee/{{$r_document->image}}" class="avatar avatar-sm me-3 ">
                                                            </a>
                                                        </div>
                                                        @endif
                                                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input required class="form-control @error('remarks_name') border-danger @enderror" value="{{ $user->name }}" type="text" placeholder="Name" id="remarks-name" name="remarks_name">
                                    @error('remarks_name')
                                        <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                    @enderror
                                </div>
