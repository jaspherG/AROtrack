                    ...
                    <div class="card-body pt-4 p-3">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input required class="form-control @error('year_admitted') border-danger @enderror" type="date" placeholder="Year Admitted" id="year_admitted" name="year_admitted" value="{{ old('year_admitted') ?? $formData->year_admitted }}" >
                                @error('year_admitted')
