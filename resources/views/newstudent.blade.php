                                                ...
                                                <td class="align-middle text-center">
                                                    <div class="d-flex align-items-center justify-content-center">
                                                        <div class="checklist">
                                                            ...
                                                            <input disabled type="checkbox" name="documents[]" value="{{ $document->id }}" {{ isset($r_document) && $r_document->status == 1 ? 'checked' : '' }} {{ isset($r_document) && $r_document->status == 1 ? 'disabled' : '' }}  >
                                                        </div>
                                                    </div>
                                                </td>
                                                <td class="align-middle text-center">
