                        ...
                        <div class="col-md-6">
                                <div class="form-group">
                                    <label for="user-name" class="form-control-label">{{ __('Previous School') }} <b class="text-danger">*</b></label>
                                        <input class="form-control @error('previous_school') border-danger @enderror" type="text" placeholder="Previous School" id="user-name" name="previous_school" value="{{ old('previous_school') ?? $formData->previous_school }}" >
